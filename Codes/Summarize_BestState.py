...
f_err1 = open(os.path.join("/home", "soham", "Simulations", "spectral-NN",ex_name,wt_fun,"Err_Best_mean.txt"),"w")
f_err2 = open(os.path.join("/home", "soham", "Simulations", "spectral-NN",ex_name,wt_fun,"Err_Best_median_range.txt"),"w")

files = os.listdir(os.path.join(folder,wt_fun,"Results_BestState"))
files.sort()

for file in files:
    with open(os.path.join(folder,wt_fun,"Results_BestState",file)) as f:
