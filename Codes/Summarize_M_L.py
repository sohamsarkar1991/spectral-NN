...
f_err1 = open(os.path.join("/home", "soham", "Simulations", "spectral-NN",ex_name,wt_fun,"Err_M_L_mean.txt"),"w")
f_err2 = open(os.path.join("/home", "soham", "Simulations", "spectral-NN",ex_name,wt_fun,"Err_M_L_median_range.txt"),"w")
...
for q in qs:
    ...
    for file in files_q:
        with open(os.path.join(folder,wt_fun,"Results_M_L",file)) as f:
